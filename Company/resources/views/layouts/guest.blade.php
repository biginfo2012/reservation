...
{{--    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('theme/images/ico/favicon.ico') }}">--}}
    ...
    <style>
        ...
        html .content{
            min-height: calc(100% - 5.1rem) !important;
            height: calc(100% - 5.1rem) !important;
        }
        .footer-gradient{
            background: rgb(35,59,108);
            background: linear-gradient(180deg, rgba(35,59,108,1) 0%, rgba(134,147,174,1) 75%, rgba(187,195,210,1) 100%);
        }
    </style>
</head>
<!-- BEGIN: Body-->
...
<!-- BEGIN: Content-->
<div class="app-content content " style="height: calc(100% - 10.35rem); overflow: hidden;">
