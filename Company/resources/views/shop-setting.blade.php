                            ...
                            <div class="row">
                                <div class="my-0 col-md-12">
                                    <table class="table table-separate table-head-custom table-checkable" id="table">
                                        <tbody>
                                            <tr>
                                                <td class="p-1 border text-start align-middle px-1">{{__('shop')}}ID</td>
                                            ...
                                            <tr>
                                                <td rowspan="2" class="p-1 border text-start align-middle px-1">〒{{$shop->shop_code}}</td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 text-end">
                                    <p>@if(!empty($shop_setting))
                                           {{$shop_setting->start_time/60 . "時" . $shop_setting->start_time%60 . "分から" . $shop_setting->end_time/60 . "時" . $shop_setting->end_time%60 . "分"}}
                                    @endif</p>
                                </div>
                                <div class="col-md-4 text-end">
                                    <p>{{__('reservation-unit')}}: @if(!empty($shop_setting))
                                                                       {{$shop_setting->reservation_unit}}
                                    @endif</p>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-5 text-end">
                                    <p>@if(!empty($shop_setting)) {{$shop_setting->accept_people}} @endif</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 text-end">
                                ...
                                <div class="col-md-5 text-end">
                                    <p>@if(!empty($shop_temp_this_month))
                                            @foreach($shop_temp_this_month as $item)
                                                {{date('m/d', strtotime($item->temp_rest))}}
                                            @endforeach
                                        @endif</p>
                                </div>
                            </div>
                    ...
                    <div class="modal-body pb-2 px-3 pt-0">
                        <form class="form" id="save_form">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-12">
                                    <textarea rows="5" id="note" class="form-control" name="note" placeholder="">{{$shop->note}}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 text-center">
                        ...
                        <form id="change_setting_form" method="POST">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-10 d-flex pr-0">
                                    <select class="form-select" name="start_time_hour">
                                        <option value="0" {{!empty($shop_setting) && $shop_setting->start_time/60 == 0 ? 'selected' : ''}}>00時</option>
                                        <option value="1" {{!empty($shop_setting) && $shop_setting->start_time/60 == 1 ? 'selected' : ''}}>01時</option>
                                        <option value="2" {{!empty($shop_setting) && $shop_setting->start_time/60 == 2 ? 'selected' : ''}}>02時</option>
                                        <option value="3" {{!empty($shop_setting) && $shop_setting->start_time/60 == 3 ? 'selected' : ''}}>03時</option>
                                        <option value="4" {{!empty($shop_setting) && $shop_setting->start_time/60 == 4 ? 'selected' : ''}}>04時</option>
                                        <option value="5" {{!empty($shop_setting) && $shop_setting->start_time/60 == 5 ? 'selected' : ''}}>05時</option>
                                        <option value="6" {{!empty($shop_setting) && $shop_setting->start_time/60 == 6 ? 'selected' : ''}}>06時</option>
                                        <option value="7" {{!empty($shop_setting) && $shop_setting->start_time/60 == 7 ? 'selected' : ''}}>07時</option>
                                        <option value="8" {{!empty($shop_setting) && $shop_setting->start_time/60 == 8 ? 'selected' : ''}}>08時</option>
                                        <option value="9" {{!empty($shop_setting) && $shop_setting->start_time/60 == 9 ? 'selected' : ''}}>09時</option>
                                        <option value="10" {{!empty($shop_setting) && $shop_setting->start_time/60 == 10 ? 'selected' : ''}} >10時</option>
                                        <option value="11" {{!empty($shop_setting) && $shop_setting->start_time/60 == 11 ? 'selected' : ''}}>11時</option>
                                        <option value="12" {{!empty($shop_setting) && $shop_setting->start_time/60 == 12? 'selected' : ''}}>12時</option>
                                        <option value="13" {{!empty($shop_setting) && $shop_setting->start_time/60 == 13? 'selected' : ''}}>13時</option>
                                        <option value="14" {{!empty($shop_setting) && $shop_setting->start_time/60 == 14 ? 'selected' : ''}}>14時</option>
                                        <option value="15" {{!empty($shop_setting) && $shop_setting->start_time/60 == 15 ? 'selected' : ''}}>15時</option>
                                        <option value="16" {{!empty($shop_setting) && $shop_setting->start_time/60 == 16 ? 'selected' : ''}}>16時</option>
                                        <option value="17" {{!empty($shop_setting) && $shop_setting->start_time/60 == 17 ? 'selected' : ''}}>17時</option>
                                        <option value="18" {{!empty($shop_setting) && $shop_setting->start_time/60 == 18 ? 'selected' : ''}}>18時</option>
                                        <option value="19" {{!empty($shop_setting) && $shop_setting->start_time/60 == 19 ? 'selected' : ''}}>19時</option>
                                        <option value="20" {{!empty($shop_setting) && $shop_setting->start_time/60 == 20 ? 'selected' : ''}}>20時</option>
                                        <option value="21" {{!empty($shop_setting) && $shop_setting->start_time/60 == 21 ? 'selected' : ''}}>21時</option>
                                        <option value="22" {{!empty($shop_setting) && $shop_setting->start_time/60 == 22 ? 'selected' : ''}}>22時</option>
                                        <option value="23" {{!empty($shop_setting) && $shop_setting->start_time/60 == 23 ? 'selected' : ''}}>23時</option>
                                    </select>
                                    <select class="form-select" name="start_time_min">
                                    ...
                                    <select class="form-select" name="end_time_hour">
                                        <option value="0" {{!empty($shop_setting) && $shop_setting->end_time/60 == 0 ? 'selected' : ''}}>00時</option>
                                        <option value="1" {{!empty($shop_setting) && $shop_setting->end_time/60 == 1 ? 'selected' : ''}}>01時</option>
                                        <option value="2" {{!empty($shop_setting) && $shop_setting->end_time/60 == 2 ? 'selected' : ''}}>02時</option>
                                        <option value="3" {{!empty($shop_setting) && $shop_setting->end_time/60 == 3 ? 'selected' : ''}}>03時</option>
                                        <option value="4" {{!empty($shop_setting) && $shop_setting->end_time/60 == 4 ? 'selected' : ''}}>04時</option>
                                        <option value="5" {{!empty($shop_setting) && $shop_setting->end_time/60 == 5 ? 'selected' : ''}}>05時</option>
                                        <option value="6" {{!empty($shop_setting) && $shop_setting->end_time/60 == 6 ? 'selected' : ''}}>06時</option>
                                        <option value="7" {{!empty($shop_setting) && $shop_setting->end_time/60 == 7 ? 'selected' : ''}}>07時</option>
                                        <option value="8" {{!empty($shop_setting) && $shop_setting->end_time/60 == 8 ? 'selected' : ''}}>08時</option>
                                        <option value="9" {{!empty($shop_setting) && $shop_setting->end_time/60 == 9 ? 'selected' : ''}}>09時</option>
                                        <option value="10" {{!empty($shop_setting) && $shop_setting->end_time/60 == 10 ? 'selected' : ''}} >10時</option>
                                        <option value="11" {{!empty($shop_setting) && $shop_setting->end_time/60 == 11 ? 'selected' : ''}}>11時</option>
                                        <option value="12" {{!empty($shop_setting) && $shop_setting->end_time/60 == 12? 'selected' : ''}}>12時</option>
                                        <option value="13" {{!empty($shop_setting) && $shop_setting->end_time/60 == 13? 'selected' : ''}}>13時</option>
                                        <option value="14" {{!empty($shop_setting) && $shop_setting->end_time/60 == 14 ? 'selected' : ''}}>14時</option>
                                        <option value="15" {{!empty($shop_setting) && $shop_setting->end_time/60 == 15 ? 'selected' : ''}}>15時</option>
                                        <option value="16" {{!empty($shop_setting) && $shop_setting->end_time/60 == 16 ? 'selected' : ''}}>16時</option>
                                        <option value="17" {{!empty($shop_setting) && $shop_setting->end_time/60 == 17 ? 'selected' : ''}}>17時</option>
                                        <option value="18" {{!empty($shop_setting) && $shop_setting->end_time/60 == 18 ? 'selected' : ''}}>18時</option>
                                        <option value="19" {{!empty($shop_setting) && $shop_setting->end_time/60 == 19 ? 'selected' : ''}}>19時</option>
                                        <option value="20" {{!empty($shop_setting) && $shop_setting->end_time/60 == 20 ? 'selected' : ''}}>20時</option>
                                        <option value="21" {{!empty($shop_setting) && $shop_setting->end_time/60 == 21 ? 'selected' : ''}}>21時</option>
                                        <option value="22" {{!empty($shop_setting) && $shop_setting->end_time/60 == 22 ? 'selected' : ''}}>22時</option>
                                        <option value="23" {{!empty($shop_setting) && $shop_setting->end_time/60 == 23 ? 'selected' : ''}}>23時</option>
                                    </select>
                                    <select class="form-select" name="end_time_min">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-10 d-flex">
                                    ...
                                    <input class="form-check-input" type="radio" name="rest_day" id="inlineRadio1" value="0" {{!empty($shop_setting) && $shop_setting->rest_day == 0 ? 'checked' : ''}} />
                                    <label class="form-check-label" for="inlineRadio1" style="margin-right: 5px;">月曜日</label>
                                    <input class="form-check-input" type="radio" name="rest_day" id="inlineRadio2" value="1" {{!empty($shop_setting) && $shop_setting->rest_day == 1 ? 'checked' : ''}} />
                                    <label class="form-check-label" for="inlineRadio2" style="margin-right: 5px;">火曜日</label>
                                    <input class="form-check-input" type="radio" name="rest_day" id="inlineRadio3" value="2" {{!empty($shop_setting) && $shop_setting->rest_day == 2 ? 'checked' : ''}} />
                                    <label class="form-check-label" for="inlineRadio3" style="margin-right: 5px;">水曜日</label>
                                    <input class="form-check-input" type="radio" name="rest_day" id="inlineRadio4" value="3" {{!empty($shop_setting) && $shop_setting->rest_day == 3 ? 'checked' : ''}} />
                                    <label class="form-check-label" for="inlineRadio4" style="margin-right: 5px;">木曜日</label>
                                    <input class="form-check-input" type="radio" name="rest_day" id="inlineRadio5" value="4" {{!empty($shop_setting) && $shop_setting->rest_day == 4 ? 'checked' : ''}} />
                                    <label class="form-check-label" for="inlineRadio5" style="margin-right: 5px;">金曜日</label>
                                    <input class="form-check-input" type="radio" name="rest_day" id="inlineRadio6" value="5" {{!empty($shop_setting) && $shop_setting->rest_day == 5 ? 'checked' : ''}} />
                                    <label class="form-check-label" for="inlineRadio6" style="margin-right: 5px;">土曜日</label>
                                    <input class="form-check-input" type="radio" name="rest_day" id="inlineRadio7" value="6" {{!empty($shop_setting) && $shop_setting->rest_day == 6 ? 'checked' : ''}} />
                ...
                for (let j = 0; j < 7; j++) {
                    if (i === 0 && j < firstDay) {
                       ...
                       break;
                        ...
                        selectOption.dataset.id = dateNumber
