<footer class="footer footer-static footer-light footer-gradient color-white">
    <p class="clearfix mb-0 d-flex"><a href="https://makidumespecialty.shop/" target="_blank" class="float-md-start d-block d-md-inline-block mt-25 color-white" style="margin-left: auto; margin-right: 0;">{{__('policy')}}</a>　｜　<a href="https://makidumespecialty.shop/privacy/" target="_blank" class="float-md-start d-block d-md-inline-block mt-25 color-white" style="margin-right: auto; margin-left: 0;">{{__('privacy')}}</a></p>
