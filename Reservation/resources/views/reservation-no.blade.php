...
<!-- BEGIN: Header-->
{{--@include('header', ['shop_setting' => $shop_setting, 'shop' => $shop])--}}
<!-- END: Header-->
...
<div class="app-content content" style="min-height: calc(100% - 6.85rem) !important; overflow: hidden; margin-left: 0 !important;">
    ...
    <div class="content-wrapper container-xxl p-0 mb-5">
        <div class="content-header row">
            <div id="complete_part" class="col-12 col-sm-12 col-md-8 col-lg-8 px-xl-0 mx-auto">
                <div class="row">
                    <div class="col-12">
                        <div id="main-title" class="text-center">
                            <h2 class="color-blue" style="font-weight: bold">{{__('reservation-cancel')}}</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
